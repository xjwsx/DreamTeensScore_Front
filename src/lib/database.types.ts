...
export interface Database {
  public: {
    Tables: {
      ...
      games: {
        Row: { id: string; name: string; emoji: string; active: boolean; floor: number; room: string; created_at: string };
        Insert: { id?: string; name: string; emoji?: string; active?: boolean; floor?: number; room?: string; created_at?: string };
        Update: { id?: string; name?: string; emoji?: string; active?: boolean; floor?: number; room?: string; created_at?: string };
        Relationships: [];
      };
      users: {
